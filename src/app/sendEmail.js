...
const smtpEmail = process.env.APP_SMTP_EMAIL;
const smtpPassword = process.env.APP_SMTP_PASSWORD;
...
class SendEmail {
  ...
  async resetPassword(email, resetPasswordToken) {
    const { transporter } = this;
    const info = await transporter.sendMail({
      from: `"Todolist Support" <${smtpEmail}>`,
      to: `${email}`,
                            ...
                            <tr>
                              ...
                              >
                                ...
                                <div align="left">
                                  ...
                                  <a
                                    href="http://localhost:3000/reset-password/new-password?token=${resetPasswordToken}"
                                    target="_blank"
                                    class="v-button"
                                    style="
                                      box-sizing: border-box;
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <!--[if (mso)|(IE)]><td align="center" width="298" style="width: 298px;padding: 20px 20px 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->

                  <!--[if (mso)|(IE)]></td><![endif]-->
                  <!--[if (mso)|(IE)]><td align="center" width="301" style="width: 301px;padding: 0px 0px 0px 20px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
                  <div
                    class="u-col u-col-50p17"
                    style="
                      max-width: 320px;
                      min-width: 301.02px;
                      display: table-cell;
